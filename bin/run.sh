...
python run.py experiment=exp011
...
./bin/train_folds.sh experiment=exp009
./bin/inference_folds.sh experiment=exp009
python src/misc/make_submission.py experiment=exp009
